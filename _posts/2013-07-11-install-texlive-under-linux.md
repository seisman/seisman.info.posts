...
本文将介绍如何在 Linux 下安装 TeXLive 2015。
...
- 官方镜像: [texlive2015.iso](http://mirrors.ctan.org/systems/texlive/Images/texlive2015.iso)
- USTC 镜像: [texlive2015.iso](http://mirrors.ustc.edu.cn/CTAN/systems/texlive/Images/texlive2015.iso)
...
TeXLive 2015 在使用 xeLaTeX 处理中文时，有自己的默认字体。大多数 Linux 发行版下，
都使用自带的 Fandol 字体。
